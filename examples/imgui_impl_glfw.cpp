...
#endif
#define GLFW_HAS_TRANSPARENT_FRAMEBUFFER (GLFW_VERSION_MAJOR * 1000 + GLFW_VERSION_MINOR * 100 >= 3300) // 3.3+ GLFW_TRANSPARENT_FRAMEBUFFER
...
#endif
#if GLFW_HAS_TRANSPARENT_FRAMEBUFFER
...
#if GLFW_HAS_TRANSPARENT_FRAMEBUFFER
    ImGuiIO& io = ImGui::GetIO();
    if (io.BackendFlags & ImGuiBackendFlags_RendererViewportsAreTransparent)
